...
const MainArticleHeader = ({title}:MainArticleHeaderProps) => {
    return (
        <div className="flex flex-col gap-4">
            ...
            <p className="lg:w-[85%] leading-7">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe recusandae aspernatur sapiente minima quaerat maiores nam, enim quasi debitis repellat.</p>
            <MainArticleInfo />
        </div>
    )
}
