...
const TakeQuiz = () => {
    ...
    return (
        <VerticalScrollWrapper heading="Take a Quiz" icon="dice" href="quizzes" >
            {quizzes?.map(item =>
                <div className="min-w-62.5 bg-cover bg-black/5 bg-blend-difference h-45 rounded-xl p-3.5 flex flex-col justify-between  transition-transform animate-duration-transition hover:scale-down hover:cursor-pointer" style={{ backgroundImage: `url(${item.img.src})`, backgroundBlendMode: "darken" }}>
